...
@Component({
  selector: 'app-test-type-finder',
  templateUrl: './test-type-finder.component.html',
  styleUrls: ['./test-type-finder.component.scss']
})
export class TestTypeFinderComponent implements OnInit {
